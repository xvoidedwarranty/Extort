getgenv().Evolution = {
    ["Options"] = {
        ...
        ["Stealth Mode"] = {
            ...
            ["Key"] = "Q", -- // Enter your Evolution Key
        },
        ["Internal"] = {
    ...
    ["Silent Aim"] = {
        ...
        ["Hit Chance"] = 300, -- // Hit chance (1-100)
    ...
    ["Cam Lock"] = {
        ...
        ["Target Mode Bind"] = "Q", -- // Keybind for Target modes
...
local AkaliNotif = loadstring(game:HttpGet("https://raw.githubusercontent.com/xvoidedwarranty/Extort/main/akali.lua"))();
local gggg = AkaliNotif.Notify;

local notificationLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/xvoidedwarranty/Extort/main/src.lua"))();
...
if Evolution["Options"]["Intro"] then 
    ...
    Image.Image = "rbxassetid://17711995604"
...
if Evolution["Options"]["Internal"].Enabled then 
    if Evolution_UI_LOADED then 
        ...
        local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/xvoidedwarranty/Extort/main/LinoriaUI.lua'))()
        local ThemeManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/xvoidedwarranty/Extort/main/LinoriaUIThemes.lua'))()
        local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/laagginq/LinoriaUI/main/save.lua'))()
        --local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/xvoidedwarranty/Extort/main/LocalSaveManager.lua'))()
